...
public partial class ExampleXX_Code_Generator
{
    private static void CreateProject(string workingDir, string projectName)
    {
    ...
    {
        var instance = new ExampleXX_Code_Generator();
        ...
        var gptConfig = LLMConfiguration.GetOpenAIGPT3_5_Turbo();
...
",
        ...
        var coderToRunnerTransition = Transition.Create(coderAgent, runner);
